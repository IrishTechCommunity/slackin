  ...
  let div = dom('.splash',
    ...
    dom('form id=invite',
      ...
      dom('input.form-item type=email name=email placeholder=you@yourdomain.com '
        + (!iframe ? 'autofocus' : '')),
      coc && dom('.coc',
        dom('p', 'You may not join solely to ',dom('a href=http://irishtechcommunity.com/codeofconduct/#you-may-not-join-if target=_blank', 'spam'),' and this will result in a ban. '+
          'Promotional posts in a channel other than <b>#selfpromo</b> or <b>#events</b> will be considered spam.'),
        dom('label',
