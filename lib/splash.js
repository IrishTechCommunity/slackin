...
export default function splash({ path, name, org, coc, logo, active, total, channels, large, iframe }){
  let div = dom('.splash',
    ...
    dom('form id=invite',
      ...
      coc && dom('.coc',
        dom('p.welcome-text',
          'Welcome to the Irish Tech Community, thank you for your interest in signing up for this community. We always welcome new members to our Slack. Due to the popularity of this Slack channel, it is within the communities best interest for it to be as Spam Free as possible. We have a guide that is widely available for ',
          dom('a href=http://irishtechcommunity.com/newuserguide/ target=_blank','New Members'),
          ' we encourage members to check this before joining.'),
          dom('p.welcome-text','If you join the community you agree to the following:',
            dom('ul.welcome-terms',
              dom('li','You are joining this community to <i>participate</i> and not to Spam. Spam includes unsolicited DM\'s to members and promotion of any kind in the main channels.'),
              dom('li','For any promotion you are doing for yourself, your company or product must be placed in <b>#selfpromo</b>'),
              dom('li','You adhere to the ',dom('a href=http://irishtechcommunity.com/codeofconduct/ target=_blank','Code of Conduct'))
...
function style({ logo, active, large, iframe } = {}){
  ...
  if (!iframe) {
    ...
    css.add('.welcome-text,.welcome-terms', {
      'margin' : '0 -10rem 2rem -10rem'
    });


    css.add('.welcome-terms', {
      'text-align' : 'left'
    });


    css.add('.welcome-terms li', {
      'margin-bottom':'1rem'
    });
